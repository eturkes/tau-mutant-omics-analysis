---
title: "NLGF vs. NLGF P301S+3 - Batch 02 - 01 GeneFunnel"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path("..", "results", "NLGF_NLGF_P301S_batch02_01genefunnel.html")
  )})
---
...
if (file.exists(rds)) {
  ...
  file_list <- c(file_list[2], file_list[3])
