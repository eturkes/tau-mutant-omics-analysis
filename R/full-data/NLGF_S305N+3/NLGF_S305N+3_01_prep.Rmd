...
data_dir <- file.path(
  "..", "..", "..", "data", "tau-mutant-omics-analysis", "full-data",
  "07-Round_2_StarSolo_mapping", "Naotos_data_for_Emir_StarSolo", "NLGF_S305N_3_2Solo.out", "Gene", "filtered"
)
...
StarSolo should have taken care of this already.
