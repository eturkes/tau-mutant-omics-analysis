...
seurat <- RenameIdents(
  object = seurat, "0" = "Cortical Glutamatergic 01", "1" = "Oligodendrocyte", "2" = "Microglia",
  "3" = "Hippocampal Glutamatergic", "4" = "Astrocyte", "5" = "Cortical Glutamatergic 02",
  "6" = "Dentate Gyrus Glutamatergic", "7" = "GABAergic", "8" = "OPC", "9" = "Endothelial", "10" = "Unknown 01",
  "11" = "Unknown 02"
)
...
seurat <- RenameIdents(
  object = seurat, "0" = "Cortical Glutamatergic", "1" = "Oligodendrocyte", "2" = "Microglia",
  "3" = "Hippocampal Glutamatergic", "4" = "Astrocyte", "5" = "Cortical Glutamatergic",
  "6" = "Dentate Gyrus Glutamatergic", "7" = "GABAergic", "8" = "OPC", "9" = "Endothelial", "10" = "Unknown 01",
  "11" = "Unknown 02"
)
seurat@active.ident <- factor(unfactor(seurat@active.ident))
