...
word_cloud = function(x, width = NULL){
  t.rW = c("cell", "process", "negative", "positive",
           ...
           "key", "mature", "selection",
           "promotor", "factor", "processing",
           ...
           "directly", "solute", "lens", "adhesion",
           "human", "roof", "poles", "genes",
           ...
           "envelope", "minusend", "comprises",
           "ruffle", "spindle",
           "dorsalventral", "segment", "sound",
           "acceptor", "primary", "network", "mechanism",
           "bubble", "vibration", "trimers", "domains",
           "activating", "heavy", "different", "retention",
           "apparatus", "pad", "organizing",
           "faces", "subunit", "lungs", "sshaped",
           "binds", "steadystate", "hap",
           "responsive", "latency", "trunk", "segments",
           "iris", "adaptor",
           "basal", "nupp",
           "commissural", "characterized",
           "tagged", "axes", "spoke",
           "pair", "still", "modifies", "considered",
           "abnormally", "integral",
           "ionotropic", "brainderived", "substratedependent",
           "plasma",
           "apical", "substructure",
           "amino", "polarized",
           "astral", "exhibited",
           ...
           "monophosphate", "phosphate",
           "oxide", "peroxynitrite", "anions",
           "tier", "rage", "ramp",
           "adenosine", "acetate", "acyl",
           "hydrolysis", "peptide", "alphabeta", "sperm",
           "surrounding", "hydrogen", "oxygen",
           "alditol", "bisphosphate", "covalent", "donor",
           "nucleophile", "polypeptide", "cerevisiae",
           "coenzyme", "dinucleotide", "lysine", "sodium",
           "cilium", "articular", "hypotonic",
           ...
           "absence", "sucrose", "completed", "receptors",
           "destined", "electron",
           "established", "fuelled",
           "proton", "pumps", "bone",
           "plate", "fructose", "particles", "atom",
           "acylglycerol", "polymerization", "carbon", "oocyte",
           "food", "line", "purine", "triggered",
           "trophoblast", "types", "sites", "eye",
           "cellderived", "acin", "gastric", "ptype",
           "radiation", "assemble", "postanal", "spans",
           "uva", "wavelengths", "hydroxyl", "enters",
           "constituents", "homology", "phosphatidylinositolkinase", "bacterium",
           "cameratype", "symbiotic", "photoreceptor", "coordination",
           "entity", "aminopentanedioic", "coordinates", "cxcxcxhxcxcxcxc",
           "cds", "galactocerebroside", "nucleosidase", "variant",
           "sources", "released", "anchor",
           "arginine", "inorganic", "glycerolphosphate", "dipeptides",
           "grampositive", "directs", "lipoteichoic", "nucleocytoplasmic",
           "promotes", "proteinprotein", "rserine", "shuttling",
           "situations", "betaine", "associate", "acidresponsive",
           "ether", "angle", "thioether",
           "shape", "carboxylate",
           "nicotinamideadenine", "attain", "lamino",
           "conjugated", "arseniccontaining", "cyclosporin", "nmethylated",
           "ciliary", "retina", "globin", "cain",
           "undecapeptide", "caout", "unusual",
           "alkylsnglycerol", "lamellipodium", "trisphosphate", "alkylsnglycerophosphoethanolamine",
           "asap", "catalysis", "lsmpat", "development",
           "membrane", "growth", "killer", "bulk",
           "expression", "nuclear", "morphogenesis", "diffusion",
           "regulatory", "intercellular", "periphery", "paracrine",
           "anergy", "passive", "deletion", "receiving",
           "galactosylceramide", "signalproducing", "galactosylceramidesulfate", "vicinity",
           "phosphoadenosine", "phosphosulfate", "ligand", "layer",
           "digestion", "stomach", "aminohindolylpropanoic", "hydrochloric",
           "oxyntic", "chiral", "parietal", "fluoride",
           "water", "division", "differentiation", "immature",
           "cleavage", "intracellular", "half", "pancreatic",
           "enzymes", "cytoplasm", "nucleus", "alphaandrostanebetabetadiol",
           "nematode", "betahydroxyalphaandrostanone", "dehydrogenase", "nadp",
           "nadph", "vitamin", "motif", "granular",
           "nucleolus", "egg", "preribosomal", "fertilization",
           "flagella", "head", "postacrosomal", "posterior",
           "polypeptides", "betacarotene", "cycle", "affected",
           "glycosyl", "derivatives", "biologically", "retinal",
           "retinaldehyde", "retinoic", "retinol", "synthesis",
           "comprise", "apoas", "place", "isoprene",
           "apocs", "isoprenoid", "isoprenoids", "methylbutenylene",
           "motile", "motion", "edge", "opposite",
           "trailing", "killing", "contact", "convert",
           "ears", "migration", "temperature", "dioxide",
           "axoneme", "cold", "flagellar", "detecting",
           "heat", "recognize", "sensor", "skin",
           "muscle", "nicotinamide", "cytokinesis", "ensure",
           "dipeptide", "bacteria", "adpribosep", "plants",
           "furrow", "hold", "furrowing", "future",
           "groove", "initiates", "marks", "metaphase",
           "recruitment", "rhoa", "shallow", "ligands",
           "metallodipeptidase", "heart", "nerve", "chemicals",
           "cation", "control", "coa", "herbicide",
           "herbicides", "kill", "temperatures", "alcohol",
           "fucosyl", "anticipate", "mannosyltransferase", "fucosylation",
           "basis", "posseses", "large", "immediately",
           "developmental", "maturation", "cytosol", "fungi",
           "elevation", "centriole", "aid", "divisions",
           "asymmetric", "morphogenetic", "fungicide", "kinases",
           "measured", "centrosome", "anus", "embryonic",
           "density", "fungicides", "balance", "destination",
           "extends", "granulosa", "final", "luteal",
           "luteinization", "luteum", "ovulation", "theca",
           "believed", "cleaved", "ehz", "focused",
           "proliferation", "soma", "constitutive", "cterminal",
           "electromagnetic", "mus", "musculus", "frequencies",
           "nanometers", "transparent", "phz", "picometers",
           "wavelength", "nonmembrane", "aminoacid", "oligopeptide",
           "pore", "proline", "arrest", "droplet",
           "arachidonic", "cone", "oligopeptides", "adult",
           "conversion", "prolinerich", "phase", "cerebral",
           "divide", "proportion", "cup", "neuroblast",
           "bardetbiedl", "vessels", "betalinked", "cartilage",
           "bbip", "betanacetyldgalactosamine", "bbs", "membranes",
           "bbsome", "biogenesis", "phosphatidate", "attained",
           "efficiently", "bringing", "blastula", "accompanied",
           "conveys", "acetyl", "embryohood", "catalyze",
           "catalytic", "myofibroblast", "undifferentiated", "phospholipase",
           "epiblast", "enlarged", "field", "neuroblasts",
           "filled", "neurectoderm", "pluripotent", "germinal",
           "optic", "maturity", "pertaining", "meiotic",
           "unspecified", "prophase", "sexual", "suspended",
           "conventional", "mesoderm", "variable", "nucleotides",
           "anteriorposterior", "aspartictype", "alkylglycerophosphoethanolamine", "myosin",
           "deoxyribose", "hindbrain", "doubleheaded", "promoters",
           "alternative", "plusend", "blastoderm", "ethanolamine",
           "esterified", "myosins", "reside", "puggtca",
           "embryo", "nucleobase", "repeat", "differential",
           "hierarchical", "nucleoside", "spaced", "generating",
           "progressive", "ribose", "ammonium", "segmentation",
           "subdivision", "alimentary", "germ", "reproduction",
           "bile", "reproductive", "duct", "nterminal",
           "entrance", "intestine", "midgut", "collagen",
           "collagenactivated", "female", "complexes", "coated",
           "ammon", "arsenates", "leucine", "filopodium",
           "cylindrical", "amacrine", "pit", "gyri",
           "arsenic", "migrating", "arsenic", "bipolar",
           "pits", "arsenides", "activator", "flagellum",
           "connections", "arsenites", "upstream", "yeast",
           "nephron", "mesenchymal", "condensation", "preventing",
           "access", "diameter", "arranged", "alters",
           "phosphatase", "anaerobic", "hydrophobic", "renal",
           "primordial", "circumferentially", "capsid", "integrated",
           "coil", "elongated", "flattened", "helical",
           "mdmmdm", "abi", "depending", "fuse",
           "alphalinked", "cisplatin", "regulators", "heptamer",
           "alignment", "dgalactose", "kinetochore", "peripheral",
           "controlling", "fewer", "centromeric", "neuromuscular",
           "kinetochoremicrotubule", "posture", "distribution", "voluntarily",
           "establishes", "determines", "vacuole", "autosome",
           "galactose", "contraction", "ester", "replication",
           "elaboration", "galactoside", "diaphragm", "anaemia",
           "feeding", "observer", "antibiotics", "glycoside",
           "skeletal", "flowing", "orthogonal", "macrolide",
           "movements", "runs", "streptomyces", "protoplasm",
           "viewpoint", "structurally", "pseudopodium", "retractile",
