...
word_cloud = function(x, width = NULL, dict = c()){
  t.rW = c(c("the", "and", "that", "process",
             ...
             "assembly", "acid", "structurally", "such",
             ...
             "alanyltrna", "aminoacyl", "nonneuronal", "carry",
             ...
             "formation", "source", "reflecting", "glucosamine",
             "atp", "adenylate", "catabolite",
             "glycoproteins", "cyclase", "extent", "monosaccharide",
             ...
             "methylbutenylene", "conditioned", "noxious", "chlorate",
             "elevation", "phospholipase", "corpus", "demise",
             "peroxide", "ion", "ions", "anion", "anions",
             "golgi", "connect", "prostaglandinendoperoxide", "odorant",
             ...
             "exits", "hindbrain", "raft", "disaccharide",
             ...
             "phosphatidylinositolmediated", "junction", "ketoprostaglandin", "junctions",
             ...
             "distribution", "framework", "puberty", "extracellular",
             "transcription", "transcriptional", "transporter", "transporters"),
           dict,
           c("mitosis", "heme", "spermiogenesis", "prolactin",
             ...
             "dental", "actin", "odontoblast", "viral",
             ...
             "epithelia", "involution", "cervix", "infectious",
