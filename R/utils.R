...
word_cloud = function(x, width = NULL, dict = c()){
  t.rW = c(c("the", "and", "that", "process",
             ...
             "excretory", "followed", "catalyzed",
             "filtration", "converted", "bcdk", "aminoacylation",
             "coupling", "derivatives", "transferred",
             ...
             "contents", "plants", "crest", "adenosine",
             ...
             "convert", "equilibrioception", "ground", "monitoring",
             "orientational", "outside", "leads", "identical",
             "cranial", "dimeric", "linear", "heterodimer",
             "activator", "arsenic", "loosely", "arseniccontaining",
             "changes", "covalently", "catalytic", "conserved",
             "organic", "polarity", "behavior", "consensus",
             "gdpdissociation", "nucleotide", "ahr", "advanced",
             "induction", "ctermini", "hctype", "coat",
             "autosome", "spliceosomal", "cuprous", "phenylalanine",
             ...
             "trna", "peptidyllysine", "peptidylnlipoylllysine", "ball",
             "general", "attack", "galactocerebroside", "confining",
             "anomeric", "based", "anticipate", "arteriosus",
             "polypeptide", "nacetyldglucosamine", "glucuronate", "basis",
             "glucuronoside", "conditioning", "glucuronosides", "consequences",
             "cysteine", "experience", "future", "peptide",
             "pharmacologically", "tetrachlorodibenzodioxine", "half", "torc",
             "amp", "granule", "approaching", "negatively",
             "adpribose", "span", "receding", "supercoiled",
             "abctype", "iodide", "caloric", "glycoside",
             "brain", "brainstem", "adp", "food",
             "capooh", "lowdensity", "connects", "alkylcobiiialamin",
             "insufficient", "formula", "bin", "hydroxyapatite",
             "extrinsic", "bout", "restriction", "mineral",
             "cobalamin", "nonorganic", "cobalt", "contained",
             "rocks", "corrin", "wholly", "possession",
             "ethanolamine", "osmolarity", "abundant", "distributed",
             "bilayer", "diphenol", "kinase", "cgmp",
             "apical", "granules", "brainderived", "almost",
             "bundles", "capsid", "alphacarbon", "compression",
             "nmrna", "ssu", "lsu", "aka",
             "endproduct", "phosphatidylethanolamine", "osmosensor", "betanacetyldgalactosamine",
             "diphenols", "regions", "aids",
             "configuration", "ampalphaacetyl", "enkephalin", "endproducts",
             "rna", "sensing", "glycolipids",
             "infiltration", "tat", "pulp", "antrum",
             "asp", "compressive", "mrna", "spanning",
             "osulfogalactosylceramide", "transactivating", "octadecanoic", "conferring",
             "ampmorpholidate", "nonprotein", "larger", "axis",
             "determined", "cortex", "arginines",
             ...
             "heartwood", "isopentenyl", "anchoring", "late",
             "regionalization", "glycinerich", "cysteinerich", "hydroxylated",
             "stages", "indolemethanol", "finger", "caused",
             ...
             "cysteinetype", "acetate", "cgmpdependent", "glycine",
             "tapered", "antiapoptotic", "adapted", "disordered",
             "carbonsulfur", "begins", "pertaining", "construction",
             "conscious", "peroxiredoxin", "nadph", "nadp",
             "nadh", "rchohr", "initiates", "charged",
             "damino", "leucineaccetping", "accetping", "longer",
             "unspecified", "deposition", "proteindisulfide", "pbr",
             "rcor", "daminoacyltrna", "leucyltrna", "alanine",
             "materials", "field", "invades", "disc",
             "proteindithol", "architecture", "sulfur", "deacylase",
             "alanyltrna", "aminoacyl", "carry",
             "anions", "adequately", "thrombinactivated", "bar",
             ...
             "prot", "niches", "receives", "activates",
             "chitooctamer", "anneal", "phospholipase", "concentric",
             "constitutes", "beneath", "coproporphyrinogen", "aminoterminal",
             "arp", "annealing", "lies", "iii",
             "ccdc", "tertiary", "protoporphyrinogen", "eruption",
             "connections", "chch", "elevate", "visible",
             "directly", "bulb", "causing", "responsible",
             "monomer", "aldohexose", "brought", "impulses",
             "bend", "closure", "bent", "folds",
             "fuse", "midline", "corpus", "demise",
             "multifunctional", "conjunction", "dipeptides",
             "mks", "dipeptidylpeptidase", "pyridoxal", "nphp",
             "pyridoxamine", "organiser", "pyridoxine", "yshaped",
             "galactohexose", "aversion", "mammalian", "resorbed",
             "utilization", "actidione", "thioesterase", "cmethylcytidine",
             "galactolipids", "galactose", "glucoside", "lactose",
             "melibiose", "oligo", "dgalactopyranosylbetanacetyldglucosamine", "galactosylgalactosylxylose",
             "aminocarbamimidamidopentanoic", "distorting", "chlorate", "intrinsically",
             "manner", "nonsequencespecific", "sequenceindependent", "straight",
             "cdcd", "phospolipase", "glycoprotein", "interpreted",
             "conditioned", "mediates", "noxious", "columnar",
             "reentry", "arachidonic", "constriction", "resumption",
             "affecting", "gravitational", "ducts", "primordia",
             "regression", "trailing", "betatype", "expulsion",
             "collecting", "discrete", "adhesions", "sulfated",
             "nascent", "matrix", "elevation", "sulfatide",
             "sulfoglycolipid", "timing", "chromate", "ironii",
             "reflecting", "catabolite", "achieved", "aspartic",
             "extent", "amplifies", "aspartictype", "frequency",
             "constant", "nucleophile", "descendants", "rate",
             "ensures", "source", "pool", "sources",
             "replenishing", "aminodeoxyglucopyranose", "symmetric", "aminodeoxysugar",
             "oacetylglucosaminyltransferase", "extracellularc", "ipm", "headtotail",
             "structurally", "odorant", "bisadenosyltriphosphatase", "proteinlserine",
             "bre", "glycosylated", "compactly", "regulate",
             "ppbisadenosyl", "proteinlthreonine", "bruno", "inactivity",
             "regulating", "proteinonacetyldglucosaminyllserine", "connect", "firm",
             "proteinonacetyldglucosaminyllthreonine", "fused", "dglyceraldehyde", "glyceraldehydephosphate",
             "commits", "amplification", "articular", "tetrachloromethane",
             "bbip", "multisubunit", "myb", "regulates",
             "bbs", "isolation", "cavities", "nematode",
             "intramembranous", "decarboxylated", "acquiring", "enriched",
             "nnbisaminopropyldiaminobutane", "reacts", "crystals", "polyamine",
             "propylamine", "methylosome", "coiled", "connectors",
             "armadillo", "actively", "car", "repeats",
             "cetn", "armrepeat", "clubshaped", "annulus",
             "horizontal", "oligopeptide", "closed", "chymotrypsinogen",
             "caudally", "oligopeptides", "link", "untranslated",
             "utr", "arising", "box", "drinking",
             "aminoacylase", "believed", "substratedependent", "aid",
             "pyloric", "compartmentalize", "dimension", "short",
             "spatial", "unidimensional", "disaccharide", "heterogeneous",
             "raft", "rafts", "sphingolipidenriched", "absent", "delta",
             "differs", "budding", "suppression", "localize",
             "mei", "spo", "spop"),
           dict,
           c("mitosis", "heme", "spermiogenesis", "prolactin",
             ...
             "bronchiole", "ooep", "scmcassociated",
             ...
             "artery", "birth", "leukotrienes", "leukotriene",
             ...
             "extraembryonic", "fungus", "gonads",
             "stereocilium", "midpiece", "kidney", "extravasation",
             "ureter", "auditory", "lactic", "benzodiazepine",
             ...
             "ovary", "ovum", "progesterone", "intrathymic",
             "medulla", "hepatic", "trophoectoderm", "antibacterial",
             "trophectoderm", "dentinogenesis", "stellate", "trophectodermal",
             "branchial", "larynx", "glossopharyngeal", "gactin",
             "blood", "betacarotene", "retinaldehyde", "retinol",
             "dgalactose", "luteolysis", "luteum", "immature",
             "endometrium", "estrous", "females", "therian",
             "nondividing", "quiescent", "mesenchymalepithelial",
             "embryos", "mullerian", "oviducts", "vagina",
             "defecation", "feces", "differentiates", "arterial",
             "cisplatin", "chitin", "interphotoreceptor", "photoreceptors",
             "retinoid", "retinoids", "collagens", "epithelioid",
             "contractile", "bardetbiedl", "muscles", "intraciliary",
             "osteoblast", "ossification", "boneforming", "gramnegative",
             "ankle", "cochlea", "glomerulus", "acinar",
             "prepubertal", "interstereocilia", "puberty", "digestion",
             "duodenum", "gastric", "motility", "peristaltic",
             "sphincter", "optic", "protozoan", "infected",
             "elegans"))
