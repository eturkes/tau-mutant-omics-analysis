...
word_cloud = function(x, width = NULL){
  t.rW = c("cell", "process", "negative", "positive",
           ...
           "membrane", "plasma",
           "apical", "substructure", "npc",
           "amino", "polarized", "expression",
           "astral", "exhibited",
           "aka", "carrying", "repeats", "repeat",
           "lumen", "enzyme", "dendrites", "acids",
           "postsynaptic", "nitrosative", "zinc", "phosphatidylinositolphosphate",
           "phosphatidylinositol", "monophosphate", "phosphate", "nitric",
           "oxide", "peroxynitrite", "superoxide", "anions",
           "tier", "rage", "ramp", "granule",
           "adenosine", "granules", "acetate", "acyl",
           "hydrolysis", "peptide", "alphabeta", "sperm",
           "surrounding", "nadp", "hydrogen", "oxygen",
           "alditol", "bisphosphate", "covalent", "donor",
           "intracellular", "nucleophile", "polypeptide", "cerevisiae",
           "coenzyme", "dinucleotide", "lysine", "sodium",
           "membranes", "cilium", "articular", "hypotonic",
