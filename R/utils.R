...
word_cloud = function(x, width = NULL, dict = c()){
  t.rW = c(c("the", "and", "that", "process",
             ...
             "results", "state", "receptor",
             "production", "result", "leading",
             "into", "etc", "form", "cells",
             "its", "expression", "specific", "terms",
             "within", "for", "involved",
             "none", "group", "catalysis", "series",
             "two", "found",
             "reaction", "signaling", "reactions",
             "assembly", "acid", "such",
             ...
             "substances", "include", "inner",
             "initial", "compound", "ends",
             ...
             "primary", "three", "hydrophobic",
             "sites", "residue", "mechanism",
             ...
             "establishment", "interactions", "organelle",
             ...
             "express", "evidence", "microorganisms",
             "codon", "aptype", "basic",
             ...
             "networks", "dependent", "permitting",
             "repulsive", "broken", "flat", "order",
             "coding", "heterotrimeric", "poles", "block",
             "sigma", "gyrus", "capacity",
             "contributing", "tolerance", "acidic",
             "homology", "limiting", "adult",
             "liquid", "astral", "inositol", "atpdependent",
             "diverse", "phosphatidyl", "approximately",
             ...
             "transcribed", "compartment", "tripeptide",
             "new", "surrounds", "mannose", "classii",
             "specialization", "opposite", "presentation",
             "segment", "toward",
             "resting", "maintaining", "alteration",
             "does", "organizing", "ability", "glycerophospholipids",
             "electrons", "tubes", "motile",
             "making", "expresses", "abundance",
             "self", "whole",
             "partner", "periodicity", "represent",
             ...
             "variable", "underlying", "asymmetric",
             "point", "seen", "fbox",
             ...
             "sequential", "perpetuation", "crawling",
             ...
             "creation", "additional", "energyindependent",
             "effectors", "protontransporting", "lobe",
             ...
             "intermediates", "every", "nacetyllactosamine",
             ...
             "glycocalyx", "outermost", "aminogroups",
             "apicalbasolateral", "helix", "deactivation",
             "cushion", "generate", "formaldehyde", "cranially",
             "retrograde", "bleaching", "methanethiol",
             "hydrolytic", "prevent", "yellow", "augment",
             "integrated", "projects", "edge", "lascorbic",
             "stalk", "whereas", "positive", "surrounded",
             "lines", "rapidly", "anterior",
             "reductase", "bodies", "characteristic",
             "striated", "arginine", "droplet", "space",
             "animal", "satellite", "acidification",
             ...
             "provide", "doublets", "occurring",
             "passage", "adjacent", "modified",
             ...
             "sulfate", "transesterification", "classi",
             "carboxyl", "genes", "stimuli", "phosphoadenosine",
             "phosphosulfate", "acyl", "extraocular", "pattern",
             "cascade", "conjugated",
             "fucose", "guanosine", "heterodimeric",
             "phosphorus", "nonantigenic", "network",
             "glutamates", "savory", "umami", "glycyl",
             "peptidylglutamic", "polyglycylation", "acute", "aryl",
             "ump", "eukaryotes", "generation", "promote",
             "contents", "plants",
             "hydroxylase", "hydroxylation", "sour", "pressure",
             "labyrinthine", "motion", "bud", "multiplication",
             "members", "secondary", "cellderived", "upon",
             "than", "udp", "gammacarboxamide", "generates",
             "gammaglutamyltransferase", "intermolecular", "intra", "isopeptide",
             "lglutaminylprotein", "llysylprotein", "nglutamyllysine", "nlisoglutamylllysine",
             "peptidylglutamine", "proteinglutamine", "proteinllysylnlglutamylprotein", "dehydrogenase",
             "reduction", "biological", "supply", "alltrans",
             "trans", "implicated", "tyrosinebased", "endonucleolytic",
             "terminate", "proton", "least",
             "events", "base", "various", "flow",
             "against", "back", "absence", "cannot",
             "ligase", "natural", "catalyze", "refers",
             "material", "gives", "towards", "canonical",
             "occur", "activate", "becomes", "array",
             "furthest", "along", "characterize", "xylosyltransferase",
             "convert", "ground", "monitoring",
             "outside", "leads", "identical",
             "cranial", "dimeric", "linear", "heterodimer",
             "activator", "arsenic", "loosely", "arseniccontaining",
             "changes", "covalently", "catalytic", "conserved",
             "organic", "polarity", "consensus",
             "gdpdissociation", "ahr", "advanced",
             "induction", "ctermini", "hctype", "coat",
             "autosome", "cuprous", "phenylalanine",
             "crich", "cds", "singlestranded", "helices",
             "arrayed", "repeat", "beat", "tetratricopeptide",
             "closely", "tpr", "columns", "inhibitor",
             "orthophosphate", "pyrimidine", "hydrocarbon", "ligandbinding",
             "triiodolthyronine", "equivalent",
             "peptidyllysine", "peptidylnlipoylllysine", "ball",
             "general", "attack", "galactocerebroside", "confining",
             "anomeric", "based", "anticipate", "arteriosus",
             "nacetyldglucosamine", "glucuronate", "basis",
             "glucuronoside", "glucuronosides", "consequences",
             "experience", "future",
             "pharmacologically", "tetrachlorodibenzodioxine", "half", "torc",
             "approaching", "negatively",
             "adpribose", "span", "receding", "supercoiled",
             "abctype", "iodide", "caloric", "glycoside",
             "brain", "adp", "food",
             "capooh", "lowdensity", "connects", "alkylcobiiialamin",
             "insufficient", "formula", "bin", "hydroxyapatite",
             "extrinsic", "bout", "restriction",
             "nonorganic", "cobalt", "contained",
             "rocks", "corrin", "wholly", "possession",
             "ethanolamine", "osmolarity", "abundant", "distributed",
             "bilayer", "diphenol",
             "apical", "brainderived", "almost",
             "bundles", "capsid", "alphacarbon", "compression",
             "ssu", "lsu", "aka",
             "endproduct", "osmosensor", "betanacetyldgalactosamine",
             "diphenols", "regions", "basophilic", "aids",
             "configuration", "ampalphaacetyl", "endproducts",
             "glycolipids",
             "tat", "pulp", "antrum",
             "asp", "compressive", "spanning",
             "osulfogalactosylceramide", "transactivating", "octadecanoic", "conferring",
             "ampmorpholidate", "nonprotein", "larger", "axis",
             "determined", "arginines", "ion", "ions", "anion", "anions", "anionic", "ionic",
             "chctype", "cation", "import", "incorporation",
             "encoding", "forces", "gtrgtr", "cmethylcytidinecontaining",
             "established", "aminopropanoic", "iretrafask",
             "belong", "dimethylallyl", "cxc", "mechanisms",
             "outward", "proximaldistal", "clnsa", "coordinates",
             "nickel", "glycation", "intermembrane", "fuelled",
             "isomer", "aipire", "cxcr", "stickiness",
             "proximal", "dimethylarginines", "cxcxcxhxcxcxcxc", "loading",
             "heartwood", "isopentenyl", "late",
             "regionalization", "glycinerich", "hydroxylated",
             "stages", "indolemethanol", "caused",
             "jbp", "sister", "mep", "trees",
             "inactive", "cyclopentanoperhydrophenanthrene", "drug", "atpproducing",
             "control", "uncoating", "intensity", "hydroperoxide",
             "lsmpat", "extensively", "organ", "cause",
             "diatomic", "controlled", "apportioned", "separation",
             "macromolecule", "helical", "cop", "shape",
             "coordinated", "lsm", "peptidylproline", "pertains",
             "portmanteau", "bundled", "represents", "event",
             "haploid", "exchange", "paired", "onecarbon",
             "taking", "term", "work", "abnormally",
             "targeting", "orderly", "visibly", "unconventional",
             "cysteinetype", "acetate", "cgmpdependent",
             "tapered", "adapted", "disordered",
             "carbonsulfur", "begins", "pertaining", "construction",
             "conscious", "peroxiredoxin", "rchohr", "initiates", "charged",
             "damino", "leucineaccetping", "accetping", "longer",
             "unspecified", "proteindisulfide", "pbr",
             "rcor", "daminoacyltrna", "leucyltrna", "alanine",
             "materials", "field", "disc",
             "proteindithol", "sulfur", "deacylase",
             "alanyltrna", "aminoacyl", "carry",
             "adequately", "thrombinactivated", "bar",
             "crystalloid", "degree", "steady", "adpdribose",
             "dendriole", "same", "mercury", "roh",
             "peptidylarginine", "holoacp", "ampnalanine", "saturated",
             "imp", "apicolateral", "cleaved",
             "solid", "biogenesis", "rooh", "before",
             "oleoylacylcarrierprotein", "ester", "inosine", "cterminal",
             "doublewalled", "area", "transient", "local",
             "zoctadecenoate", "stearic", "lysine", "zoctadecenoylacp",
             "methyl", "cyclohexanehexol", "help", "inputs",
             "prospective", "monophosphoramidase", "diphosphoinositol", "individual",
             "recognizable", "monophosphoramidate", "monophosphate",
             "roots", "resides", "polyphosphate", "ingression",
             "ctp", "multilayered", "column",
             "concomitant", "triphosphate", "undergo",
             "coenzyme", "coenzymes", "enzyme", "enzymes",
             "factor", "factors", "cofactors", "cofactor",
             "feii", "earliest", "fully",
             "prot", "delta", "aldohexose", "differs",
             "dgalactose", "galactohexose", "galactolipids", "galactose",
             "glucoside", "lactose", "melibiose", "oligo",
             "arising", "eruption", "beneath", "believed",
             "connections", "visible", "lies", "iii",
             "elevate", "constitutes", "chch", "tertiary",
             "affecting", "oacetylglucosaminyltransferase",
             ...
             "mammalian", "resorbed", "variant",
             "formation", "source", "reflecting",
             "glycoproteins", "extent", "monosaccharide",
             "neuraminic", "frequency", "sialic", "rate",
             "atpase", "sources", "dimension",
             "causing", "achieved", "amplifies", "constant",
             "descendants", "ensures", "pool", "replenishing",
             "symmetric", "glycoprotein", "gravitational", "isoprene",
             "phorbol", "anesthetic", "aversion",
             "methylbutenylene", "noxious", "chlorate",
             "elevation", "phospholipase", "corpus", "demise",
             "peroxide", "ion", "ions", "anion", "anions",
             "connect", "prostaglandinendoperoxide", "odorant",
             "nematode", "arachidonic", "tryptophanaccetping", "lcysteinylprotein",
             "tryptophanyltrna", "conjunction", "cylindrical", "brush",
             "brought", "closure", "folds", "fuse",
             "midline", "chymotrypsinogen", "accretion", "web",
             "cooperation", "substratedependent", "kinetochoremicrotubule", "ducts",
             "triggers", "chiasm", "mediates", "regression",
             "rig", "conducts", "crossing", "enters",
             "exits", "raft", "disaccharide",
             "ketone", "betacarotene", "oxobutyrate", "oxobutyric",
             "alphaoxidation", "betaoxidation", "aminocarbamimidamidopentanoic", "lysobisphosphatidic",
             "introducing", "lysophosphatidic", "monoacylglycerol", "lamino",
             "maintains", "aminoacylase", "nacyllamino", "omethylnucleotide",
             "joint", "omethyltransferase", "hydroxyproline", "lbd",
             "aminobutanedioic", "sulcus", "phospolipase", "aspartate",
             "superior", "aspartic", "temporal", "interpreted",
             "chloride", "extend", "dipeptides", "parent", "parents",
             "expulsion", "conductance", "tag", "interprets",
             "bulb", "polymerases", "eggs", "giving", "laying",
             "polymerase", "bisadenosyltriphosphatase", "ppbisadenosyl", "headtotail",
             "macromolecular", "dribose",
             "hemidesmosome", "betaine", "ntrimethyl", "dihydroketoprostaglandin",
             "phosphatidylinositolmediated", "ketoprostaglandin",
             "polypeptide", "polypeptides", "stereocilia",
             "sulfated", "germline", "oxygen",
             "elaboration", "germline", "clubshaped", "patch",
             "acrosomal", "destroyed", "polyadpdribose", "prepubertal",
             "distribution", "framework", "puberty",
             "transporter", "transporters",
             "compartmentalize", "oligosaccharide", "cdcd", "activates",
             "cavities", "coiled",
             "fungicide", "chemicals", "penetration", "fused",
             "egg", "sugar", "aspartictype",
             "acylglycerol", "cyclasesgc", "pigmentation", "melanin",
             "sulfoglycolipid", "sulfatide", "recognition", "nacylsphingoid",
             "phosphatidylethanolamine", "biotic", "gramnegative", "burst",
             "clathrate", "accompanied", "removed", "acylglycerol",
             "sphingoid", "enwrapped", "consumption", "living",
             "melanosome", "cyclic", "transport", "nucleophile",
             "sugars", "polyspermy", "zona", "fungicides",
             "exudate", "enriched", "destructively", "subsets",
             "hydrophilic", "elevated", "pigments", "stored",
             "dermatan", "peritoneum", "directly", "polar",
             "radicals", "tissuespecific", "liduronylbetanacetyldgalactosamine", "pleural",
             "harbors", "suppress", "respiratory", "regulating",
             "introduced", "physiologic", "heterogeneous", "rafts",
             "sphingolipidenriched", "entrance", "middle", "midgut",
             "noncanonical", "passed", "bilaterally", "paraxial",
             "plan", "mesodermderived", "persists", "serves",
             "substitute", "vertebrae", "vertebral", "coreceptor",
             "joints", "corneal", "endothelium", "lymphatics", "serous",
             "special", "maintenance", "observer", "orthogonal",
             "viewpoint", "bed", "venous", "maintain",
             "preventing", "coreceptors",
             "synthesize", "cardiomyocytes", "conduction",
             "regulate", "almondshaped", "medial", "alkali",
             "exception", "periodic", "table", "posessing", "efficiency",
             "dioxide", "dioxygen", "gaseous", "improves", "makes",
             "ventilated", "ampicilin", "exposed", "foreign", "organim",
             "xenobiotic", "exoskeleton", "glycosylated", "appears",
             "fibroblasts", "integral", "vinculin", "centripetal",
             "contractile", "divides", "organelles", "resist",
             "link", "nacetylgalactosamine", "oglycosidic", "typical",
             "articular", "antiporter", "contrast", "cystineglutamate",
             "erythroid", "lightchain", "promotion",
             "reducing", "slca", "vanishing", "voltagedependent",
             "oligopeptide", "oligopeptides", "balance", "gshgssg",
             "indicating", "nadnadh", "cytoplasms", "cytoplasm",
             "cytoplasmic", "daltons", "dalton", "live",
             "offspring", "intramitochondria", "intramitochondrial", "stretch",
             "establishes", "coordinating"),
           dict,
           c("mitosis", "heme", "spermiogenesis", "prolactin",
             "trophoblast", "adipose", "hepatocyte", "follicles",
             "oocyte", "axonemal", "cuticle",
             ...
             "hemolymph", "gametes", "progenitor",
             "epithelium", "melaninfilled", "melanocytes",
             "placental", "epithelial", "reproduction", "phase",
             "division", "contraction", "mitotic", "morphogenesis",
             "fibers", "fiber", "fate",
             "bacteria", "myoblasts", "sperm",
             "eye", "muscle", "urine", "migration", "proliferation",
             "replication", "vertebrate", "fibroblast", "vertebrates",
             "yeast", "reproductive", "ooplasm", "differentiation",
             "bone", "rod", "atrium", "cava",
             "birth",
             ...
             "stilbene", "stilbenoid", "stilbenoids", "embryo",
             "alveolus", "maturation", "archaea", "chorionic",
             "extraembryonic", "myosins", "fungus", "gonads",
             "stereocilium", "midpiece", "kidney", "extravasation",
             "ureter", "lactic", "benzodiazepine",
             "cones", "acrosomic", "chondrocyte",
             "blastocyst", "otic", "gastrulation",
             "heart", "pericardium", "vena",
             "chordates", "melanogaster",
             ...
             "trophectoderm", "chitooctamer", "quiescent",
             "bloodretinal", "myristate", "luteolysis", "luteum",
             "epithelia", "involution", "cervix",
             "collagenactivated", "trophectodermal", "anisomycin", "spermatogonia",
             "primordial", "spermatocytes", "spermatogonial", "optic",
             "orbit", "retinaldehyde", "retinol", "retinoid",
             "mesenchymalepithelial", "defecation", "feces", "osteoclast",
             "isoprenoids", "isoprenoid", "react",
             ...
             "character", "mother", "podocyte", "floor",
             "anatomical", "modifying", "movable"),
             c("somatic",
               "als"))
