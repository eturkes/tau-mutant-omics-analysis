...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "NLGF_S305N+3_01_prep_no_introns.html"
  ))})
---
...
data_dir <- file.path(
  "..", "..", "data", "low-coverage",
  "03-Cellranger_mapping", "Cellranger_output_without_introns", "NaotoS6_no_introns", "outs"
)
cache_dir <- file.path("..", "..", "cache", data_name, paste0("0", analysis_no, "-no-introns"))
