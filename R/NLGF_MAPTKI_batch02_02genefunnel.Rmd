...
seurat$annotations_short <- factor(
  ...
  levels = c(
      "Dentate Gyrus Glutamatergic", "Cortical Glutamatergic", "Hippocampal Glutamatergic", "GABAergic", "Endothelial",
...
sce <- suppressWarnings(
  aggregateAcrossCells(sce, colData(sce)[ , "annotations_short"], use_exprs_values = "counts", statistics = "mean")
)
