...
seurat <- RenameIdents(
  object = seurat, "0" = "Cortical Glutamatergic", "1" = "Oligodendrocyte", "2" = "Astrocyte",
  "3" = "Dentate Gyrus Glutamatergic", "4" = "Hippocampal Glutamatergic", "5" = "Microglia", "6" = "GABAergic",
  "7" = "Endothelial", "8" = "Unknown"
)
