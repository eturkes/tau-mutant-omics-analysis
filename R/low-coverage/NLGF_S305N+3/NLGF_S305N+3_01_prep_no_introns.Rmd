---
title: "NLGF S305N+3 - 01 Prep - No Introns"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "..", "results",
      unlist(strsplit(getwd(), "/"))[6], unlist(strsplit(getwd(), "/"))[7], "NLGF_S305N+3_01_prep_no_introns.html"
  )}))
---
...
data_dir <- file.path(
  ...
  "low-coverage", "03-Cellranger_mapping", "Cellranger_output_without_introns", "NaotoS6_no_introns", "outs"
)
