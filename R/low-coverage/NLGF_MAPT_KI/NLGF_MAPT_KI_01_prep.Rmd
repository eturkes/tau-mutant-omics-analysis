...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "..", "results",
      unlist(strsplit(getwd(), "/"))[6], unlist(strsplit(getwd(), "/"))[7], "NLGF_MAPT_KI_01_prep.html"
  )}))
---
...
data_dir <- file.path(
  ...
  "low-coverage", "03-Cellranger_mapping", "Cellranger_output_with_introns", "NaotoS3_APP_MAPT_KI_with_introns", "outs"
)
...
if (file.exists(rds)) {
  ...
  poi <- round(0.2 * nrow(seurat@meta.data))
  bcmvn <- find.pK(sweep)
