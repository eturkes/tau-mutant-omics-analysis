...
data_dir <- file.path(
  ...
  "08_Batch_2_StarSolo_mapping", "S6_2_6Solo.out", "Gene", "raw"
)
...
seurat <- RenameIdents(
  object = seurat, "0" = "Cortical Glutamatergic 01", "1" = "Hippocampal Glutamatergic", "2" = "Oligodendrocyte",
  "3" = "GABAergic", "4" = "Dentate Gyrus Glutamatergic", "5" = "Astrocyte", "6" = "Cortical Glutamatergic 02",
  "7" = "Microglia", "8" = "OPC", "9" = "Endothelial"
)
...
seurat <- RenameIdents(
  object = seurat, "0" = "Cortical Glutamatergic", "1" = "Hippocampal Glutamatergic", "2" = "Oligodendrocyte",
  "3" = "GABAergic", "4" = "Dentate Gyrus Glutamatergic", "5" = "Astrocyte", "6" = "Cortical Glutamatergic",
  "7" = "Microglia", "8" = "OPC", "9" = "Endothelial"
)
seurat@active.ident <- factor(unfactor(seurat@active.ident))
