...
data_dir <- file.path(
  ...
  "08_Batch_2_StarSolo_mapping", "S5_2_5Solo.out", "Gene", "raw"
)
...
seurat <- RenameIdents(
  object = seurat, "0" = "Cortical Glutamatergic 01", "1" = "Cortical Glutamatergic 02", "2" = "Oligodendrocyte",
  "3" = "Astrocyte", "4" = "GABAergic", "5" = "DG Glutamatergic", "6" = "Hippocampal Glutamatergic",
  "7" = "Cortical Glutamatergic 03", "8" = "Endothelial", "9" = "Microglia", "10" = "Unknown 01", "11" = "OPC",
  "12" = "Unknown 02"
)
...
seurat <- RenameIdents(
  object = seurat, "0" = "Cortical Glutamatergic", "1" = "Cortical Glutamatergic", "2" = "Oligodendrocyte",
  "3" = "Astrocyte", "4" = "GABAergic", "5" = "Dentate Gyrus Glutamatergic", "6" = "Hippocampal Glutamatergic",
  "7" = "Cortical Glutamatergic", "8" = "Endothelial", "9" = "Microglia", "10" = "Unknown 01", "11" = "OPC",
  "12" = "Unknown 02"
)
seurat@active.ident <- factor(unfactor(seurat@active.ident))
