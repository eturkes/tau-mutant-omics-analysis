  ...
  for (l in 10:26) {
    ...
    for (m in seq_along(modules)) {
      ...
      if (length(modules_up) == 0) {
        ...
        frequent_genes <- frequent_genes[frequent_genes$Var1 %in% rownames(module_membership_norm), ]
        module_membership_norm_sub <- module_membership_norm[
        ...
        frequent_genes$Freq <-
          (frequent_genes$Freq / rowSums(abs(module_membership_norm_sub))) *
            ...
            (sqrt(frequent_genes$Freq / length(modules_up)))
