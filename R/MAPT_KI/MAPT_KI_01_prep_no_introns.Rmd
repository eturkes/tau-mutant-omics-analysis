...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "MAPT_KI_01_prep_no_introns.html"
  ))})
---
...
data_dir <- file.path(
  "..", "..", "data", "low-coverage",
  "03-Cellranger_mapping", "Cellranger_output_without_introns", "NaotoS1_MAPT_KI_no_introns", "outs"
)
