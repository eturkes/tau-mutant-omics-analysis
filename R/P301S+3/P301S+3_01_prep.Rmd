...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path("..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "P301S+3_01_prep.html")
  )})
---
...
data_dir <- file.path(
  "..", "..", "data", "low-coverage",
  "03-Cellranger_mapping", "Cellranger_output_with_introns", "NaotoS2_P301S+3_with_introns", "outs"
)
